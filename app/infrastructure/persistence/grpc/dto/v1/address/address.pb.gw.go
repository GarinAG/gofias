...
var (
	filter_AddressHandler_GetAddressByTerm_0 = &utilities.DoubleArray{Encoding: map[string]int{"term": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
var (
	...
	pattern_AddressHandler_GetAddressByTerm_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 3}, []string{"api", "v1", "address", "term"}, "", runtime.AssumeColonVerbOpt(true)))
	...
	pattern_AddressHandler_GetCitiesByTerm_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 3}, []string{"api", "v1", "cities", "term"}, "", runtime.AssumeColonVerbOpt(true)))
)
