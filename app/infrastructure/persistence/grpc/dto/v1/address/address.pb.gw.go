...
func request_AddressHandler_GetAddressByTerm_0(ctx context.Context, marshaler runtime.Marshaler, client AddressHandlerClient, req *http.Request, pathParams map[string]string) (AddressHandler_GetAddressByTermClient, runtime.ServerMetadata, error) {
	...
	stream, err := client.GetAddressByTerm(ctx, &protoReq)
	if err != nil {
...
func RegisterAddressHandlerHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AddressHandlerClient) error {
	...
	mux.Handle("GET", pattern_AddressHandler_GetAddressByTerm_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_AddressHandler_GetAddressByTerm_0(ctx, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	...
	forward_AddressHandler_GetAddressByTerm_0 = runtime.ForwardResponseStream
