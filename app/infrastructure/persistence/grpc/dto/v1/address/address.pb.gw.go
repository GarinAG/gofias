...
var (
	filter_AddressHandler_GetAddressByTerm_1 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_AddressHandler_GetAddressByTerm_1(ctx context.Context, marshaler runtime.Marshaler, client AddressHandlerClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq TermFilterRequest
	var metadata runtime.ServerMetadata
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_AddressHandler_GetAddressByTerm_1); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_AddressHandler_GetAddressByTerm_1(ctx context.Context, marshaler runtime.Marshaler, server AddressHandlerServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq TermFilterRequest
	var metadata runtime.ServerMetadata
...
var (
	filter_AddressHandler_GetSuggests_1 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_AddressHandler_GetSuggests_1(ctx context.Context, marshaler runtime.Marshaler, client AddressHandlerClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SimpleTermFilterRequest
	var metadata runtime.ServerMetadata
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_AddressHandler_GetSuggests_1); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_AddressHandler_GetSuggests_1(ctx context.Context, marshaler runtime.Marshaler, server AddressHandlerServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SimpleTermFilterRequest
	var metadata runtime.ServerMetadata
...
func RegisterAddressHandlerHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AddressHandlerServer) error {
	...
	mux.Handle("POST", pattern_AddressHandler_GetAddressByTerm_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
	...
	mux.Handle("GET", pattern_AddressHandler_GetAddressByTerm_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_AddressHandler_GetAddressByTerm_1(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_AddressHandler_GetAddressByTerm_1(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_AddressHandler_GetSuggests_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
	...
	mux.Handle("GET", pattern_AddressHandler_GetSuggests_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_AddressHandler_GetSuggests_1(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_AddressHandler_GetSuggests_1(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterAddressHandlerHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AddressHandlerClient) error {
	...
	mux.Handle("GET", pattern_AddressHandler_GetAddressByTerm_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_AddressHandler_GetAddressByTerm_1(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_AddressHandler_GetSuggests_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_AddressHandler_GetSuggests_1(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_AddressHandler_GetAddressByTerm_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "v1", "address", "term"}, "", runtime.AssumeColonVerbOpt(true)))
	...
	pattern_AddressHandler_GetSuggests_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "suggests"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_AddressHandler_GetAddressByTerm_0 = runtime.ForwardResponseMessage

	forward_AddressHandler_GetAddressByTerm_1 = runtime.ForwardResponseMessage
	...
	forward_AddressHandler_GetSuggests_1 = runtime.ForwardResponseMessage
)
